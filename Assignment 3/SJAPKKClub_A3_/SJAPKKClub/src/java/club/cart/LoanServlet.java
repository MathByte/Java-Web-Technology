...
public class LoanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                if (loanItems == null)
                {
                // Call loadItems method from ELoan.java class which takes path as input and result is
                    loanItems = ELoan.loadItems(path);
                
                    context.setAttribute("loanitems", loanItems);
                }
                RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ELoan.jsp");
